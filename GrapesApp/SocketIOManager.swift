...
class SocketIOManager {
    let socketioManager = SocketManager(socketURL: URL(string: "http://localhost:3000")!, config: SocketIOClientConfiguration(arrayLiteral: .log(false), .compress)) //10.3.141.100
